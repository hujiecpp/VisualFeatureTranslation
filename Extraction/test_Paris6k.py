...
parser = argparse.ArgumentParser(description = 'Test Paris6k mAP.')
...
parser.add_argument('--galary_path', required = True, help = './Paris6k/galary/')
parser.add_argument('--query_path', required = True, help = './Paris6k/query/')
...
for file in query_files:
    ...
    for i in range(sz):
        ...
        resultFile.write(re)
    # Evaluating
    t = os.popen('./compute_ap ./Paris6k_gnd/' + query + ' ' + result_file_name)
    ap = float(t.read())
    mAP = mAP + ap
    resultFile.close()
