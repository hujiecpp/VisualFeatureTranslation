...
def test_Holidays(ori_name, dst_name, d2d, ori_dim, dst_dim):
    ...
    # mlp = MLP(ngpu, ori_dim, dst_dim).cuda()
    # mlp_model_dir = "./checkpoint/Holidays/{}/mlp.pth".format(d2d)
    # print(mlp_model_dir)
    # mlp_state_dict = torch.load(mlp_model_dir)
...
# 
    # mlp = MLP(ngpu, ori_dim, dst_dim).cuda()
    # mlp_model_dir = "./checkpoint/Oxford5k/{}/mlp.pth".format(d2d)
    # print(mlp_model_dir)
    # mlp_state_dict = torch.load(mlp_model_dir)
    # mlp.load_state_dict(mlp_state_dict)
    # mlp.eval()
...
# 
    # mlp = MLP(ngpu, ori_dim, dst_dim).cuda()
    # mlp_model_dir = "./checkpoint/Paris6k/{}/mlp.pth".format(d2d)
    # print(mlp_model_dir)
    # mlp_state_dict = torch.load(mlp_model_dir)
    # mlp.load_state_dict(mlp_state_dict)
    # mlp.eval()
...
if __name__ == "__main__":
    ...
    mAP_filename = './result/mAP_result.txt'
    mAP_file = open(mAP_filename, 'a')

    # dis_filename = './result/dis_result_Paris6k.txt'
    ...
    for ori in descs:
        ...
        for dst in descs:
            ...
            ori_dim = dims[ori]
            dst_dim = dims[dst]
            mAP = test_Holidays(ori, dst, d2d, ori_dim, dst_dim)
    ...
    for ori in descs:
        ...
        for dst in descs:
            ...
            ori_dim = dims[ori]
            dst_dim = dims[dst]
            mAP = test_Oxford5k(ori, dst, d2d, ori_dim, dst_dim)
    ...
    for ori in descs:
        ...
        for dst in descs:
            ...
            ori_dim = dims[ori]
            dst_dim = dims[dst]
            mAP = test_Paris6k(ori, dst, d2d, ori_dim, dst_dim)
